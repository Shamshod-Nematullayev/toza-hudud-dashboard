...
const COMMON_REASONS = [
  'Billingdagi FIO bilan HET FIO mos kelmadi',
  'Elektr hisob raqami noto‘g‘ri kiritilgan',
  'Boshqa xonadonga / abonentga tegishli',
  'SaOTo (tuman) hududi noto‘g‘ri tanlangan',
  'Abonent manzili mos kelmadi'
];
        ...
        <Stack direction="row" spacing={1.5} sx={{ alignItems: 'center' }}>
          ...
          <Box>
            <Typography variant="h4" sx={{ fontWeight: 700 }}>
              Elektr kodi so'rovini bekor qilish
            </Typography>
